...
class TelaDadosCliente():
    ...
    def init_components(self, dados_cliente):
        layout = [
            ...
            [sg.Text("Nome:", size=(12, 1)), sg.InputText(dados_cliente["nome"], key='nome')],
            [sg.Text("País de Origem:", size=(12, 1)), sg.InputText(dados_cliente["pais_origem"], key='pais_origem')],
            [sg.Text("Local de Sede:", size=(12, 1)), sg.InputText(dados_cliente["local_sede"], key='local_sede')],
            [sg.Text("Código:", size=(12, 1)), sg.InputText(dados_cliente["codigo"], key='codigo')],
